...
<link href="<?php echo  base_url(); ?>css/jQueryUI/jquery-ui-1.10.3.custom.min.css" rel="stylesheet">    
...
<link href="<?php echo  base_url(); ?>css/ExpertCalendar.css" rel="stylesheet">
<style>
	.fc-header-title h2 {
    	font-size: 20px;
	}
...
<!-- Start:Model PopUp window to create serviceRequest -->
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="width: 132%;">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
        <span id="myModalLabel1">CREATE APPOINTMENT</span>
    </div>
    <div class="modal-body">
    <form id="createAppointmentForm" class="form-horizontal">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label class="col-sm-4 control-label" for="selectedDateTime">Date:</label>
            <div class="col-sm-8">
                <input id="selectedDateTime" type="text" class="form-control"/>
            </div>
        </div>
         <div class="form-group">
            <label class="col-sm-4 control-label" for="availableSlots">Time:</label>
            <div class="col-sm-8">
					...
					//if ( console && console.log ) {
					 ...
					 if(data.result.success){
					  ...
					  refreshCalendar();
						 ...
						 $('#exceptionPanel').text(data.result.message);
					 }
