          ...
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
                <i class="fa fa-globe"></i> <?php echo $ContactDetails->Name; ?>.
				  <?php 
            ...
            <div class="col-sm-4 invoice-col">
              <address>
                <strong></strong><br>
					...
					<?php echo $ContactDetails->MailingCountry; ?> <?php echo $ContactDetails->MailingPostalCode; ?><br/>
                Email: <?php echo $ContactDetails->Email; ?>
              </address>
            </div><!-- /.col -->
            <div class="col-sm-4 invoice-col">
