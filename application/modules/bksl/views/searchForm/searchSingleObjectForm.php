...
<script type="text/javascript" language="javascript" class="init"> 
	...
	if(searchResult != null){
		...
		for(var i=0;i< allDetailsById.length;i++){ 
			...
			var count;  
			buildListViewTableBody +='<td class="actions" style="vertical-align: initial !important;padding: 0px !important;"><a href="<?php echo  base_url(); ?>bksl/'+allDetailsById[i].uId+'/e" style="text-decoration: none;">&nbsp;&nbsp;Edit</a></td>';
			for(key in fieldsToDisplay){
			...
			buildListViewTableBody += '</tr>';
					...
					tableBuilder +='<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">';
