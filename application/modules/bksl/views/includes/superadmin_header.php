...
<html>
  <head>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>js/lib/plugins/select2/select2.min.css">
    <!-- Theme style -->
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
					<div class="pull-left">
                      <a href="<?php echo base_url();?>bksl/auth/change_password" class="btn btn-default btn-flat">Change Password</a>
                    </div>
            ...
            <?php $sizeOfTab = count($profileTabs);
				for($i=0; $i<$sizeOfTab; $i++){  ?>
			  		 <li class="<?php $isActive = '';
							if ($title == $profileTabs[$i]['activeTab'] || $title == $profileTabs[$i]['activeListTab']) { 
