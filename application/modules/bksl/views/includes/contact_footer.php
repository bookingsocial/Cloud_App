            ...
            <form method="post" id="ContactSettingsForm">
              ...
              <div class="form-group">
                <label class="control-sidebar-subheading">
                  Activate do not distrube
                  	<input type="hidden"  name="Id" value="<?php echo $ContactDetails->Id; ?>"/>
					<?php 
						if($ContactDetails->Do_Not_Distrub){ 
                  			echo '<input type="checkbox" class="pull-right" checked="checked" name="Do_Not_Distrub" onChange="doSubmit();" />';
					 	}else{
                  	    	echo '<input type="checkbox" class="pull-right" name="Do_Not_Distrub"  onChange="doSubmit();"/>';
						}
					?>
                </label>
                <p>
	...
	<script type="text/javascript">
		function doSubmit(){
			$.ajax({ 
			   type: "POST",
			   data: $('#ContactSettingsForm').serialize(),
			   url: "<?php echo base_url();?>bksl/contactSettings",
