...
class Tank_auth
{
	...
	function get_user_by_id()
	{
		...
		return $this->ci->users->get_user_by_id($user_id,TRUE);
	}
	/**
	 * Get user_id
	 *
	 ...
	 * @return	array
	 */
	function create_user($data, $email_activation)
	{
	 ...
	 * @return	bool
	 */
	function admin_activate_user($user_id)
	{
		if ((strlen($user_id) > 0)) {
			return $this->ci->users->admin_activate_user($user_id);
		}
		return FALSE;
	}
	 ...
	 * @return	bool
	 */
	function admin_deactivate_user($user_id)
	{
		if ((strlen($user_id) > 0)) {
			return $this->ci->users->admin_deactivate_user($user_id);
		}
		return FALSE;
	}
	/**
